    ...
    return (
      ...
      body= {show? (inUser ? ( 
        <>
            ...
            <button type="submit" disabled={ value ?false:true} className="btn btn-dark" onClick={handleWithdraw}>Withdraw!</button>
        </>
        ) : ("Please Log In!")) : ( "Success! Balance is $" + inUser.user.balance)}
