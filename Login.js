    ...
    return (
      <Card
        ...
        body={show ? (  
                <>
                Email Address:<br/>
                <input type="input" className="form-control" id="email" placeholder="ex: Bruce Wayne" value={email} onChange={e => setEmail(e.currentTarget.value)}/><br/>
                Password<br/>
                ...
                <button type="submit" disabled={(password && email) ?false:true} className="btn btn-dark" onClick={handleLogin}>Submit!</button>
                </>
              ):(
                <>
                <h5>Success!</h5>
